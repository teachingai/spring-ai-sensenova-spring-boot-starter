package org.springframework.ai.sensetime.sensenova.controller;
...
public class ChatController {
    ...
    private final SensetimeAiSensenovaChatClient chatClient;

    @Autowired
    public ChatController(SensetimeAiSensenovaChatClient chatClient) {
